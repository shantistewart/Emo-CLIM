...
def compute_retrieval_metrics(query_embeds: List, query_labels: List, item_embeds: List, item_labels: List, metric_names: List, k_vals: List, device: Any) -> Dict:
    ...
    assert set(metric_names) <= set(SUPPORTED_RETRIEVAL_METRICS), "At least one metric in metric_names isn't supported."
